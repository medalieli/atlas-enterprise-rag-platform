...
$env:API_IMAGE = 'rag-api:post-v1-enterprise-verification'
$env:FRONTEND_IMAGE = 'rag-frontend:post-v1-enterprise-verification'
...
$env:RELEASE_REVISION = 'post-v1-enterprise-verification'
$env:BUILD_DATE = '2026-08-29T00:00:00Z'
