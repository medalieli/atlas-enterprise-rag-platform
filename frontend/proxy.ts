...
export function proxy(request: NextRequest) {
  ...
  const publicPath = request.nextUrl.pathname === "/login" || request.nextUrl.pathname === "/health" || request.nextUrl.pathname === "/invitations/accept" || request.nextUrl.pathname.startsWith("/api/auth/") || request.nextUrl.pathname.startsWith("/api/invitations/");
